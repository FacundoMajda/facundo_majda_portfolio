        ...
        >
          ...
          >
            <Liquid
              ...
              radius={0.15}
            >
              <div className="relative z-30 container mx-auto h-full flex flex-col lg:flex-row justify-start lg:justify-between items-center lg:items-end gap-12 lg:gap-16 px-6 md:px-20 lg:px-24 pt-20 md:pt-24 pb-12">
